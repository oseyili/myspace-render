...
const [route, setRoute] = useState(currentRoute());
  ...
  return (
    <div style={styles.page}>
      ...
      {route === "insurance" && (appProps.selectedHotel ? <InsurancePortal {...appProps} /> : <TripExtrasLocked />)}
      {route === "transfers" && (appProps.selectedHotel ? <TransfersPortal {...appProps} /> : <TripExtrasLocked />)}
      {route === "attractions" && (appProps.selectedHotel ? <AttractionsPortal {...appProps} /> : <TripExtrasLocked />)}
...
function AttractionsPortal(props) {
  return (
    <PortalShell
      title="Experiences"
      subtitle="Add destination experiences after choosing your MySpace Hotel stay."
      badge="After hotel selection"
    >
      <section style={styles.panel}>
        <div style={styles.panelHeader}>
          <div>
            <div style={styles.kicker}>Hotel booking protected</div>
            <h2 style={styles.titleSmall}>Explore experiences after securing your stay</h2>
            <p style={styles.sectionText}>
              Your MySpace Hotel stay remains the main booking journey. Experiences are offered only as optional trip extras after hotel selection.
            </p>
          </div>
        ...
        <div style={styles.cardGrid}>
          <InfoCard title="Tours and activities" text="Add suitable destination activities after your hotel choice is confirmed." />
          <InfoCard title="Museum and attraction tickets" text="Plan your visit without replacing your MySpace Hotel accommodation booking." />
          <InfoCard title="Transport and eSIM options" text="Add useful travel extras only after your hotel stay is selected." />
        </div>

        <div style={styles.success}>
          MySpace Hotel keeps accommodation first. Partner extras are shown only as optional additions to your selected trip.
        </div>
      </section>
    </PortalShell>
  );
