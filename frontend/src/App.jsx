...
export default function App() {
  ...
  async function searchHotels() {
    ...
    try {
      ...
      // Facilities are treated as optional preferences only.
    ...
    <div style={styles.page}>
      ...
      <section style={styles.panel}>
        ...
        <div style={styles.facilities}>
          <h3>Preferred facilities</h3><p style={styles.facilityHint}>Optional preferences only. Hotels are not hidden because supplier facility tags are often incomplete.</p>
