...
function currencyForCountry(country) {
  const lowered = String(country || "").toLowerCase();
...
function StatCard({ label, value }) {
  return (
    ...
    >
      ...
      <div
        style={{
          fontSize: String(value).length > 18 ? 18 : 22,
          fontWeight: 800,
...
function TextInput({ value, onChange, placeholder, dark = false }) {
  return (
    <input
      value={value}
      ...
      style={{
        width: "100%",
        borderRadius: 14,
        border: dark ? "1px solid rgba(255,255,255,0.18)" : "1px solid #dbe3ef",
        background: dark ? "rgba(255,255,255,0.1)" : "#f8fafc",
        color: dark ? "#fff" : "#0b1628",
        padding: "14px 16px",
        outline: "none",
        fontSize: 16,
...
export default function App() {
  ...
  async function fetchHotels(targetPage, append) {
    if (append) {
      setLoadingMore(true);
    } else {
      ...
      >
        ...
        >
          ...
          >
            ...
            <div style={{ display: "grid", gap: 10 }}>
              <TextInput value={destination} onChange={setDestination} placeholder="Destination" dark />
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10 }}>
                <TextInput value={country} onChange={setCountry} placeholder="Country" dark />
                <TextInput value={city} onChange={setCity} placeholder="City" dark />
                <TextInput value={locationText} onChange={setLocationText} placeholder="Location" dark />
              </div>
        ...
        >
          ...
          >
            ...
            <div style={{ display: "grid", gap: 10 }}>
              <TextInput value={guestName} onChange={setGuestName} placeholder="Guest name" />
              <TextInput value={guestEmail} onChange={setGuestEmail} placeholder="Guest email" />
              <div
                style={{
                  borderRadius: 14,
                  border: "1px solid #dbe3ef",
