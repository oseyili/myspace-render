...
export default function App() {
  ...
  const [statusText, setStatusText] = useState("More choice, clearer comparisons, and a faster path to booking with trusted partners.");
  ...
  const filteredHotels = useMemo(() => {
    ...
    return hotels.filter((hotel) => {
      ...
      return selectedFacilities.every((wanted) => {
        ...
        return facilities.some((existing) => existing.includes(target) || target.includes(existing));
      });
    });
          ...
          <div>
            ...
            >
              <button
                type="button"
                onClick={() =>
                  setStatusText("Travel guides help customers compare destinations, areas, and hotel styles before they book.")
                }
                style={{
                  border: 0,
                  borderRadius: "16px",
              ...
              <button
                type="button"
                onClick={() =>
                  setStatusText("Frequently asked questions explain booking, facilities, pricing, and stay details clearly.")
                }
                style={{
          ...
          {!filteredHotels.length ? (
            ...
            >
              {filteredHotels.map((hotel, index) => {
                ...
                const selected = selectedHotel?.id === hotel?.id || selectedHotel?.name === hotel?.name;
                    ...
                    <div style={{ padding: "18px" }}>
                      ...
                      >
                        <div>
                          ...
                          >
                            {hotel.location || hotel.address || `${hotel.city || ""} ${hotel.country || ""}`}
                          </div>
                        </div>
                      ...
                      >
                        <div>
                          <div style={{ color: "#64789d", fontSize: "13px", fontWeight: 800 }}>
                            from
                          </div>
                          <div
                            style={{
