...
export default function App() {
  ...
  if (page === "terms") return <InfoPage onBack={() => setPage("home")} title="Booking terms"><p>Hotel conditions, prices, taxes, cancellation terms, and availability can vary by property, room type, dates, and supplier. Please review details carefully before payment.</p>
<p><b>Price differences and supplier confirmation:</b><br />Hotel prices, taxes, fees, room availability, cancellation terms, and supplier conditions can change. If a hotel or supplier later confirms a higher final price than the price displayed or paid through MySpace Hotel, the customer is responsible for paying any difference required by the hotel or supplier before check-in or during check-in.</p>
<p><b>Customer responsibility before arrival:</b><br />Customers should confirm their booking details, final price, room count, dates, and check-in requirements directly with the booked hotel by email before travelling to the property.</p>
<p><b>Supplier protection:</b><br />MySpace Hotel displays and processes booking information based on supplier responses and available data. Hotels and suppliers remain responsible for their final room availability, check-in rules, taxes, fees, and property-level conditions.</p></InfoPage>;
