        ...
        <div style={styles.twoCol}>
          <div>
            ...
            <div style={styles.results}>
              {hotels.map((hotel) => (
                <div key={hotel.hotel_id || hotel.id} style={selectedHotel?.hotel_id === hotel.hotel_id ? styles.cardSelected : styles.card} onClick={() => setSelectedHotel(hotel)}>
          ...
          <aside style={styles.reserve}>
            ...
            <button style={styles.goldButton} onClick={sendRequest}>
              {selectedHotel?.live_payment_ready ? "Continue securely" : "Send reservation request"}
            </button>
