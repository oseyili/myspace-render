        ...
        <div style={styles.twoCol}>
            ...
            <div style={styles.results}>
              {hotels.map((hotel) => (
                <div key={hotel.hotel_id || hotel.id} style={selectedHotel?.hotel_id === hotel.hotel_id ? styles.cardSelected : styles.card} onClick={() => setSelectedHotel(hotel)}>
                  ...
                  <div style={hotel.first_rate?.rate_key ? styles.priceLine : styles.pricePending}>
                    {hotel.first_rate?.rate_key
                      ...
                      : "Latest price and room availability will be confirmed"}
                  </div>
                  <div style={hotel.first_rate?.rate_key ? styles.rateGood : styles.ratePending}>
                    {hotel.first_rate?.rate_key ? "Live room price available" : "Reservation request required"}
                  </div>
                </div>
              ))}
            </div>
          ...
          <aside style={styles.reserve}>
            ...
            <button style={styles.goldButton} onClick={sendRequest}>
              {selectedHotel?.first_rate?.rate_key ? "Continue securely" : "Send reservation request"}
            </button>
