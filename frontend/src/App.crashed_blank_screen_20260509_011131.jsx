...
const COUNTRY_CITY_OPTIONS = {
  "United Kingdom": ["London", "Greater London", "Manchester", "Birmingham", "Liverpool", "Edinburgh", "Glasgow", "Cardiff", "Bristol", "Leeds"],
  "United States": ["New York", "Miami", "Los Angeles", "Orlando", "Chicago", "Las Vegas", "San Francisco", "Boston", "Seattle", "Washington DC"],
  "Nigeria": ["Lagos", "Abuja", "Port Harcourt", "Ibadan", "Benin City", "Kano", "Enugu", "Calabar", "Owerri", "Uyo"],
  "Italy": ["Rome", "Milan", "Naples", "Florence", "Bologna", "Turin", "Venice", "Verona", "Palermo"],
  "France": ["Paris", "Nice", "Lyon", "Marseille", "Bordeaux", "Toulouse", "Cannes", "Lille"],
  "Spain": ["Barcelona", "Madrid", "Valencia", "Seville", "Malaga", "Palma de Mallorca", "Alicante", "Granada"],
  "Germany": ["Berlin", "Munich", "Hamburg", "Frankfurt", "Cologne", "Dusseldorf", "Stuttgart"],
  "Netherlands": ["Amsterdam", "Rotterdam", "The Hague", "Utrecht", "Eindhoven"],
  "United Arab Emirates": ["Dubai", "Abu Dhabi", "Sharjah", "Ajman"],
  "Turkey": ["Istanbul", "Antalya", "Izmir", "Bodrum", "Ankara"],
  "South Africa": ["Cape Town", "Johannesburg", "Pretoria", "Durban", "Sandton"],
  "Kenya": ["Nairobi", "Mombasa", "Kisumu", "Nakuru", "Diani Beach"],
  "Ghana": ["Accra", "Kumasi", "Cape Coast", "Takoradi"],
  "Portugal": ["Lisbon", "Porto", "Faro", "Albufeira"],
...
<select
  ...
  onChange={(e) => {
    ...
    const nextCity = (COUNTRY_CITY_OPTIONS[nextCountry] || [""])[0];
    setCountry(nextCountry);
    setCity(nextCity);
    setHotels([]);
    setSelectedHotel(null);
    setMessage(`Choose your destination in ${nextCountry}.`);
  }}
>
...
<select
  ...
  onChange={(e) => {
    ...
    setHotels([]);
    setSelectedHotel(null);
    setMessage(`Ready to search stays in ${e.target.value}, ${country}.`);
  }}
>
