...
export default function App() {
  ...
  return (
    <div style={styles.page}>
      <section style={{ ...styles.hero, backgroundImage: `linear-gradient(145deg, rgba(10,36,92,.92), rgba(25,86,190,.86)), url(${dest.image})` }}>
      ...
      <section style={styles.panel}>
        ...
        <div style={styles.globalButtons}>
          {["LON","PAR","BCN","DXB","AMS","MAD","IST","PMI","PRG","VIE","BER","NCE","ATH","DUB","NYC"].map((code) => (
            <button
              key={code}
              style={city === code ? styles.globalButtonActive : styles.globalButton}
...
const styles = {
  ...
  globalButtons: { display: "flex", flexWrap: "wrap", gap: 8, margin: "8px 0 16px" },
  globalButton: { background: "white", border: "1px solid #c6d5e8", borderRadius: 999, padding: "9px 13px", fontWeight: 900, cursor: "pointer" },
  globalButtonActive: { background: "#ffd34d", border: "1px solid #07111f", borderRadius: 999, padding: "9px 13px", fontWeight: 900, cursor: "pointer" },
